                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class="bg-light p-3 animated fadeIn page-content">
                            <form id="upload_dokumen-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("upload_dokumen/add?csrf_token=$csrf_token") ?>" method="post">
                                <div>
                                    <div class="form-group ">
                                        <label class="control-label" for="nama_dokumen">Nama Dokumen </label>
                                        <div id="ctrl-nama_dokumen-holder" class=""> 
                                            <textarea placeholder="Enter Nama Dokumen" id="ctrl-nama_dokumen"  rows="2" name="nama_dokumen" class="htmleditor form-control"><?php  echo $this->set_field_value('nama_dokumen',""); ?></textarea>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div id="ctrl-jenis_dokumen-holder" class=""> 
                                                    <input id="ctrl-jenis_dokumen"  value="<?php  echo $this->set_field_value('jenis_dokumen',""); ?>" type="text" placeholder="Enter Jenis Dokumen"  name="jenis_dokumen"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
