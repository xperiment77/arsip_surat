                ...
                <div class="row ">
                    ...
                    <div class="col-md-8 comp-grid">
                        ...
                        <div  class="bg-light p-3 animated fadeIn page-content">
                            <form id="arsip-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("arsip/add?csrf_token=$csrf_token") ?>" method="post">
                                <div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-upload_dokumen-holder" class=""> 
                                                        <div class="dropzone " input="#ctrl-upload_dokumen" fieldname="upload_dokumen"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                            <input name="upload_dokumen" id="ctrl-upload_dokumen" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_dokumen',""); ?>" type="text"  />
